...
<template>
  <button
    class="inline-flex h-7 gap-1 rounded border border-gray-50 bg-black/90 px-3 font-mono text-sm uppercase text-gray-50 transition-colors hover:bg-gray-800"
    :class="[
      primary

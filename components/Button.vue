...
const classes = {
  ...
  regular:
    "self-start	flex h-7 items-center gap-1 rounded border border-gray-50 bg-black/90 px-2 font-mono text-sm uppercase text-gray-300 transition hover:bg-gray-800 disabled:pointer-events-none disabled:opacity-20",
  primary:

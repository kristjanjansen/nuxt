...
const classes = {
  small:
    "flex gap-1 font-mono text-xs uppercase text-grey-300 transition-colors hover:text-grey-500 tracking-wide",
  regular:
    "inline-flex h-7 items-center gap-1 rounded border border-grey-50 bg-black/90 px-2 font-mono text-sm uppercase text-grey-300 transition-colors hover:bg-grey-800 disabled:pointer-events-none disabled:opacity-20",
  primary:
